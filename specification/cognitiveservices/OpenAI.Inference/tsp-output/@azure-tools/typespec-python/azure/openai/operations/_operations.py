...
def build_audio_transcriptions_text_request(deployment_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_audio_translations_text_request(deployment_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CompletionsOperations:
    ...
    def _create(
        ...
        _request = build_completions_create_request(
...
class ChatOperations:
    ...
    def _create_extensions(
        ...
        _request = build_chat_create_extensions_request(
            deployment_id=deployment_id,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
...
class ImagesOperations:
    ...
    def __generate_initial(self, body: Union[_models._models.ImageGenerationOptions, JSON, IO], **kwargs: Any) -> JSON:
        ...
        _request = build_images_generate_request(
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
            headers=_headers,
...
class AudioOperations:
    ...
    def _transcriptions(  # pylint: disable=protected-access
        ...
        _request = build_audio_transcriptions_request(
            deployment_id=deployment_id,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
    ...
    def _translations(  # pylint: disable=protected-access
        ...
        _request = build_audio_translations_request(
            deployment_id=deployment_id,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
    ...
    def _transcriptions_text(  # pylint: disable=protected-access
        self,
        deployment_id: str,
    ...
    def _transcriptions_text(
        ...
        _request = build_audio_transcriptions_text_request(
            deployment_id=deployment_id,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
    ...
    def _translations_text(  # pylint: disable=protected-access
        self,
        deployment_id: str,
    ...
    def _translations_text(
        ...
        _request = build_audio_translations_text_request(
            deployment_id=deployment_id,
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
